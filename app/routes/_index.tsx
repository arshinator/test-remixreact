...
function HomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-start items-start bg-gray-100 p-4">
      <div className="w-full rounded shadow-md text-center mb-4 p-8 bg-gradient-to-b from-purple-500 to-purple-300">
        <div className="text-6xl font-bold text-white mb-4">{currentDateTime}</div>
      </div>
